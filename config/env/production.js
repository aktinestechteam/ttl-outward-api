...
module.exports = {
	...
	datastores: {
		...
		default: {
			adapter: 'sails-mongo',
			//url: 'mongodb://10.139.56.86:49140/inwardcargo'
			url: 'mongodb://mongodb01.ttgroupglobal.local:27017,mongodb02.ttgroupglobal.local:27017/outwardcargo?ssl=true&readPreference=primary&replicaSet=idos&connectTimeoutMS=3000&w=1&slaveOk=true',
			// url: 'mongodb://mongodb01.ttgroupglobal.local:27017,mongodb02.ttgroupglobal.local:27017/inwardcargo?ssl=true&readPreference=primary&replicaSet=idos&connectTimeoutMS=3000&w=1&slaveOk=true',
			ssl: {
			     ca: ["/home/ubuntu/ssl/mongo_mumbai.crt", "/home/ubuntu/ssl/mongo_paris.crt"]
			}
			// adapter: 'sails-mysql',
	...
	security: {
		 ...
		 ***************************************************************************/
		 cors: {
			allRoutes: true,
			allowOrigins: ['https://caps.ttgroupglobal.com'],
